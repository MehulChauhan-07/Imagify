  ...
  return (
    <div className="relative flex flex-col justify-center items-center text-center py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        >
          <div className="mt-12">
            <button className="group relative sm:text-lg text-white bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 px-12 py-4 flex items-center gap-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 mx-auto">
